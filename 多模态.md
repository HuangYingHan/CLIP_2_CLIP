...
5个来自5个类别的图片和对应5个text:

| Precision | Recall |
| --------- | ------ |
| 0.9904    | 0.9946 |

10个来自5个类别的图片和对应10个text

| Precision | Recall |
| --------- | ------ |
| 0.6586    | 0.6622 |

4个来自2个类别的图片和对应4 个text

| Precision | Recall |
| --------- | ------ |
| 0.399     | 0.374  |

2个来自一个类别的图片和对应两个text(无阈值限制)
